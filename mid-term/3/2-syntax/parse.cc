// Generated by Bisonc++ V5.02.00 on Mon, 19 Oct 2020 18:50:39 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {297, 1}, // 14: statement ->  reapeat
     {303, 6}, // 15: reapeat (T_REPEAT) ->  T_REPEAT statements T_UNTIL expression T_DONE T_SEMICOLON
     {298, 4}, // 16: assignment (T_ID) ->  T_ID T_ASSIGN expression T_SEMICOLON
     {299, 5}, // 17: read (T_READ) ->  T_READ T_OPEN T_ID T_CLOSE T_SEMICOLON
     {300, 5}, // 18: write (T_WRITE) ->  T_WRITE T_OPEN expression T_CLOSE T_SEMICOLON
     {301, 5}, // 19: branch (T_IF) ->  T_IF expression T_THEN statements T_ENDIF
     {301, 7}, // 20: branch (T_IF) ->  T_IF expression T_THEN statements T_ELSE statements T_ENDIF
     {302, 5}, // 21: loop (T_WHILE) ->  T_WHILE expression T_DO statements T_DONE
