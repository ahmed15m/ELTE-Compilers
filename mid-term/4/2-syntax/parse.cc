// Generated by Bisonc++ V5.02.00 on Mon, 19 Oct 2020 19:07:17 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {296, 5}, // 6: declaration (T_LESS) ->  T_LESS types_list T_GR T_ID T_SEMICOLON
     {295, 1}, // 7: statements ->  statement
     {295, 2}, // 8: statements ->  statement statements
     {298, 2}, // 9: statement (T_SKIP) ->  T_SKIP T_SEMICOLON
     {298, 1}, // 10: statement ->  assignment
     {298, 1}, // 11: statement ->  read
     {298, 1}, // 12: statement ->  write
     {298, 1}, // 13: statement ->  branch
     {298, 1}, // 14: statement ->  loop
     {299, 4}, // 15: assignment (T_ID) ->  T_ID T_ASSIGN expression T_SEMICOLON
     {299, 6}, // 16: assignment (T_ID) ->  T_ID T_DOT T_NUM T_ASSIGN expression T_SEMICOLON
     {300, 5}, // 17: read (T_READ) ->  T_READ T_OPEN T_ID T_CLOSE T_SEMICOLON
     {300, 7}, // 18: read (T_READ) ->  T_READ T_OPEN T_ID T_DOT T_NUM T_CLOSE T_SEMICOLON
     ...
     {304, 1}, // 23: expression (T_NUM) ->  T_NUM
     {304, 1}, // 24: expression (T_TRUE) ->  T_TRUE
     {304, 1}, // 25: expression (T_FALSE) ->  T_FALSE
     {304, 1}, // 26: expression (T_ID) ->  T_ID
     {304, 3}, // 27: expression (T_ID) ->  T_ID T_DOT T_NUM
     {304, 3}, // 28: expression (T_ADD) ->  expression T_ADD expression
     {304, 3}, // 29: expression (T_SUB) ->  expression T_SUB expression
     {304, 3}, // 30: expression (T_MUL) ->  expression T_MUL expression
     {304, 3}, // 31: expression (T_DIV) ->  expression T_DIV expression
     {304, 3}, // 32: expression (T_MOD) ->  expression T_MOD expression
     {304, 3}, // 33: expression (T_LESS) ->  expression T_LESS expression
     {304, 3}, // 34: expression (T_GR) ->  expression T_GR expression
     {304, 3}, // 35: expression (T_EQ) ->  expression T_EQ expression
     {304, 3}, // 36: expression (T_AND) ->  expression T_AND expression
     {304, 3}, // 37: expression (T_OR) ->  expression T_OR expression
     {304, 2}, // 38: expression (T_NOT) ->  T_NOT expression
     {304, 3}, // 39: expression (T_OPEN) ->  T_OPEN expression T_CLOSE
     {305, 1}, // 40: type (T_BOOLEAN) ->  T_BOOLEAN
     {305, 1}, // 41: type (T_INTEGER) ->  T_INTEGER
     {297, 1}, // 42: types_list ->  type
     {297, 3}, // 43: types_list (T_COMMA) ->  type T_COMMA types_list
     {306, 1}, // 44: program_$ ->  program
};
