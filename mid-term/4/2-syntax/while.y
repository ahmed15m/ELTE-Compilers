...
|
    T_LESS types_list T_GR T_ID T_SEMICOLON
    {        
        std::cout << "declaration -> T_LESS types_list T_GR T_ID T_SEMICOLON" << std::endl;   
    }
;
...
types_list:
    type
    {
        std::cout << "types_list -> type" << std::endl;
    }
|
    type T_COMMA types_list
    {
        std::cout << "types_list -> type T_COMMA types_list" << std::endl;
    }
;